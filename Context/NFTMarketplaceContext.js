...
const projectId = "2OKm1UjtwpX1A4zgMzj7tKC3nug";
const projectSecretKey = "105d0f24a33383ceb09dcfd04f385511";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://block-art-market.infura-ipfs.io";
...
export const NFTMarketplaceProvider = ({ children }) => {
  const titleData = "Creating, Showcasing & Trading digital art pieces as NFTs";
